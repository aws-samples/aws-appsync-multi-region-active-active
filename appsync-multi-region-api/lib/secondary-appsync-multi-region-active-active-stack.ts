...
interface SecondaryAppSyncMultiRegionActiveActiveStackProps extends cdk.StackProps {
...
export class SecondaryAppsyncMultiRegionActiveActiveStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: SecondaryAppSyncMultiRegionActiveActiveStackProps) {
